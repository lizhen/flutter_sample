import 'package:article/bean/button_bean.dart';
...
class BottomSettings {
  ...
  List<Tab> themeTabs() {
    ...
    for (Color color in themeColors) {
      tabs.add(Tab(icon: Icon(Icons.color_lens, color: color)));
    }
    return tabs;
  }
  ...
  Widget starredList(bool starred, Color themeColor, Function onStarredPressed,
      Function onStarredListPressed) {
      ...
      MaterialButton(
        child: Row(
          children: <Widget>[
            ...
            Text(
              S.of(context).action_starred_list,
              style: style,
            )
          ],
        ),
